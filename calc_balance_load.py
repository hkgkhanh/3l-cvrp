...
INPUT_DIR = "my-runs/output/Gendreau_et_al_2006"
OUTPUT_CSV = "my-runs/output/balance_loading.csv"
OUTPUT_SUMMARY_CSV = "my-runs/output/balance_loading_summary.csv"
...
def main():
    ...
    for inst_dir in sorted(os.listdir(INPUT_DIR)):
        ...
        sol_path = os.path.join(
            inst_path,
            "SolutionValidator",
            f"Solution_{inst_dir}.txt"
        )

        if os.path.isfile(sol_path):
            solution_files.append((inst_dir, sol_path))

    for instance, filepath in solution_files:
